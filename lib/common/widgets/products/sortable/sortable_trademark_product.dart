...
class ESortableTrademarkProduct extends StatelessWidget {
  const ESortableTrademarkProduct({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final source = product.isEmpty ? '' : product[0].trademarkModel?.source;
    return Column(
      children: [
        DropdownButtonFormField<String>(
          ...
          value: controller.selectedSortOption.value.isEmpty
              ...
              : controller.selectedSortOption.value,
          onChanged: (value) {
            controller.sortProducts(source!, value!);
          },
          items: [
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () =>
                                controller.loadMoreProducts(source!),
